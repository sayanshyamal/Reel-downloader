...
export const metadata: Metadata = {
  ...
  description:
    "Download YouTube videos and Shorts instantly as MP4 in HD quality. No app, no login, no watermark. The fastest free online YouTube video downloader.",
  keywords: [
    "youtube downloader",
    ...
    "yt shorts download online free",
  ...
  openGraph: {
    ...
    description:
      "Download YouTube videos and Shorts instantly as MP4 in HD. No app, no login. Best free YouTube downloader online.",
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Copy the YouTube video URL, paste it into AnyClip's input field, and click Download.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes! AnyClip fully supports downloading YouTube Shorts in their original vertical format and quality.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "YouTube videos are downloaded in MP4 format, which works on all devices.",
        },
      },
    ],
  };
